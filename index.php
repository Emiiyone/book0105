...
<header>
    <?php if(isset($_SESSION['chk_ssid'])): ?>
        <div class="navLogout"><a class="" href="logout.php">LOGOUT</a></div>
    <?php else: ?>
        <div class="navLogin"><a class="" href="login.php">LOGIN</a></div>
    <?php endif; ?>
</header>
    ...
    <div class="wrapper">
        ...
        <div class="serch">
            ...
            <div class="buttonWrap"><button id="send">Serch</button></div>
        </div>
        <?php
        // ログインしている場合のみMY PAGEを表示
            if(isset($_SESSION['chk_ssid'])) {     
                echo '<div class="myPage"><a href="select.php">MY PAGE</a></div>';
            }
        ?>
        <div class="bookList">
            <table id="list">
            ...
            <button id="getCheckedValuesButton" style="display: none;">Register</button>
            <div id="loginModal" class="modal" style="display: none;">
                <div class="modal-content">
                    <span class="modalClose">&times;</span>
                    <p>書籍登録をするには、ログインをしてください。</p>
                    <div class="inputContainer">
                        <form name="form1" action="login_act.php" method="post">
                            ID:<input type="text" name="lid" placeholder="Username" />
        ...
        <form method="post" action="insert.php">
            <div class="jumbotron" style="display:none;">
                ...
                <button id="submitFormButton">Add My Page</button>
            </div>
        </form>
    </div>
    <!-- Main[End] -->
    ...
    $(document).ready(function() {
        // ログイン状態のチェック
        let isLoggedIn = <?= isset($_SESSION['chk_ssid']) ? 'true' : 'false'; ?>;
        
        $(document).on('click', '.myCheckbox', function(e) {
            if (!isLoggedIn) {
                e.preventDefault(); // チェックボックスのデフォルト動作を阻止
                this.checked = false; // チェック状態を解除
                $('#loginModal').show(); // モーダルを表示
            }
        });
        ...
        selectedBookDataArray.forEach(function (bookData, index) {
            $('#set').append(`
                <div class="book-entry">
                    ...
                    <div><button type="button" class="remove-book">Delete</button></div>
                    <!-- 隠しフィールド -->
    ...
    $("#submitFormButton").click(function (e) {
        ...
        .done(function(data) {
            console.log(data); 
            alert("登録に成功しました。"); // 成功アラート
            window.location.href = 'index.php'; 
        })
        .fail(function(jqXHR, textStatus, errorThrown) {
            alert("登録できませんでした。"); // 失敗アラート
